...
# USAGE: qsub -V -b n -cwd /gpfs/serena/rnaseq_test/cellranger_count_YCC10-DMSO-sept2017.sh

# output folder: run_count_YCC10-DMSO-sept2017
# data directory: /gpfs/serena/single_cell/sept_2017/10X_K4_YCC10-DMSO
# sample id: 10X_K4_YCC10-DMSO
...
cellranger count --id=run_count_YCC10-DMSO-sept2017 \
--fastqs=/gpfs/serena/single_cell/sept_2017/10X_K4_YCC10-DMSO \
--sample=10X_K4_YCC10-DMSO \
