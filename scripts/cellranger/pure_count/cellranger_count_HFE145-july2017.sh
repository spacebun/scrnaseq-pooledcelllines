...
# USAGE: qsub -V -b n -cwd /gpfs/serena/rnaseq_test/cellranger_count_HFE145-july2017.sh

# output folder: run_count_HFE145-july2017
# data directory: /gpfs/serena/single_cell/july_2017/10X_K1_HFE145
# sample id: 10X_K1_HFE145
...
cellranger count --id=run_count_HFE145-july2017 \
--fastqs=/gpfs/serena/single_cell/july_2017/10X_K1_HFE145 \
--sample=10X_K1_HFE145 \
