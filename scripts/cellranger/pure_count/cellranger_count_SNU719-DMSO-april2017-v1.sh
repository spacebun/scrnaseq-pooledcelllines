...
#This is a version rewritten on 13 Dec as an error was found in the outs of the run of the original script.
...
# USAGE: qsub -V -b n -cwd /gpfs/serena/scrnaseq/scripts/cellranger/cellranger_count_SNU719-DMSO-april2017-v1.sh
