...
# USAGE: qsub -V -b n -cwd /gpfs/serena/rnaseq_test/cellranger_count_YCC10-Aza-sept2017.sh

# output folder: run_count_YCC10-Aza-sept2017
# data directory: /gpfs/serena/single_cell/sept_2017/10X_K5_YCC10-Aza
# sample id: 10X_K5_YCC10-Aza
...
cellranger count --id=run_count_YCC10-Aza-sept2017 \
--fastqs=/gpfs/serena/single_cell/sept_2017/10X_K5_YCC10-Aza \
--sample=10X_K5_YCC10-Aza \
