...
# USAGE: qsub -b n -pe smp 8 /gpfs/serena/scrnaseq/scripts/cellranger/mixed/cellranger_count_mixed_DMSO.sh

# output folder: /gpfs/serena/scrnaseq/results/run_cellranger_count_mixed/mixed_DMSO
# data directory: /gpfs/serena/mixed_cell_lines/cell_DMSO
# sample id: cell_DMSO
...
cellranger count --id=mixed_DMSO \
--fastqs=/gpfs/serena/mixed_cell_lines/cell_DMSO \
--sample=cell_DMSO \
