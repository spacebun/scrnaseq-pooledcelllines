...
## Set directory
setwd("/Users/serena/scrnaseq/results/pure_indiv/july2017/HFE145-july2017/v1")

## Load the Dataset
HFE145.july2017.data <- Read10X(data.dir = "/users/serena/scrnaseq/results/cellranger-outs/july_2017/HFE145-july2017/filtered_feature_bc_matrix")
...
# capture.output(HFE145.july2017.seuratobject,file = "HFE145-july2017-seuratresults.txt", append = TRUE)
#
# dense.size <- object.size(as.matrix(HFE145.july2017.data))
# cat("\n\n", file = "HFE145-july2017-seuratresults.txt", append = TRUE)
...
#
# sparse.size <- object.size(HFE145.july2017.data)
# cat("\n\n", file = "HFE145-july2017-seuratresults.txt", append = TRUE)
...
setwd("/Users/serena/scrnaseq/results/pure_indiv/july2017/HFE145-july2017/v1")
save(HFE145.july2017.seuratobject, file="filtered-HFE145-july2017-v1.RData")
...
save(HFE145.july2017.seuratobject, file="SCT-HFE145-july2017-v1.RData")
...
# cat("\n", file = "HFE145-july2017-seuratresults.txt", append = TRUE)
# capture.output(print(HFE145.july2017.seuratobject[["pca"]], dims = 1:10, nfeatures = 5),file = "HFE145-july2017-seuratresults.txt", append = TRUE)
