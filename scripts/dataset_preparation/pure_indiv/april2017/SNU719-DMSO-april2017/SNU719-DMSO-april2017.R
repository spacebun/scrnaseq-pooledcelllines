...
## Set directory
setwd("/Users/serena/scrnaseq/results/pure_indiv/april2017/SNU719-DMSO-april2017")

## Load the Dataset
SNU719.DMSO.april2017.data <- Read10X(data.dir = "/users/serena/scrnaseq/results/cellranger-outs/april_2017/SNU719-DMSO-april2017/filtered_feature_bc_matrix")
...
cat("SNU719-DMSO-april2017-Seurat Object", file = "SNU719-DMSO-april2017-seuratresults.txt")
cat("\n", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
capture.output(SNU719.DMSO.april2017.seuratobject,file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)

dense.size <- object.size(as.matrix(SNU719.DMSO.april2017.data))
cat("\n\n", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
cat("dense.size", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
cat("\n", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
capture.output(dense.size,file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)

sparse.size <- object.size(SNU719.DMSO.april2017.data)
cat("\n\n", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
cat("sparse.size", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
cat("\n", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
capture.output(sparse.size,file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)

cat("\n\n", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
cat("dense.size/sparse.size", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
cat("\n", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
capture.output(dense.size/sparse.size,file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
...
setwd("/Users/serena/scrnaseq/results/pure_indiv/april2017/SNU719-DMSO-april2017/Quality Metric Plots")
...
setwd("/Users/serena/scrnaseq/results/pure_indiv/april2017/SNU719-DMSO-april2017")
save(SNU719.DMSO.april2017.seuratobject, file="filtered-SNU719-DMSO-april2017-v0.RData")
...
SNU719.DMSO.april2017.phase <- RunPCA(SNU719.DMSO.april2017.seuratobject)
# Plot the PCA colored by cell cycle phase
# Should observe variation by cell cycle
png('Cell Cycle PCA.png')
DimPlot(SNU719.DMSO.april2017.phase,
       reduction = "pca",
       group.by = "Phase")
dev.off()
# Run SCTransform: Normalizes data, Scales Data, Finds variable features
...
# Perform PCA
SNU719.DMSO.april2017.phase.regressed <- RunPCA(SNU719.DMSO.april2017.seuratobject)

# Now, a PCA on the variable genes no longer returns components associated with cell cycle
png('Cell Cycle Regressed PCA.png')
DimPlot(SNU719.DMSO.april2017.phase.regressed,
        reduction = "pca",
        group.by= "Phase")
dev.off()
...
save(SNU719.DMSO.april2017.seuratobject, file="SCT-SNU719-DMSO-april2017-v0.RData")


# Linear Dimensional Reduction------------------------------------
dir.create("Linear Dimensional Reduction")
setwd("/Users/serena/scrnaseq/results/pure_indiv/april2017/SNU719-DMSO-april2017/Linear Dimensional Reduction")
...
cat("\n\n", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
cat("Most variable genes driving PCs", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
cat("\n", file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
capture.output(print(SNU719.DMSO.april2017.seuratobject[["pca"]], dims = 1:10, nfeatures = 5),file = "SNU719-DMSO-april2017-seuratresults.txt", append = TRUE)
...
setwd("/Users/serena/scrnaseq/results/pure_indiv/april2017/SNU719-DMSO-april2017")
save(SNU719.DMSO.april2017.seuratobject, file="LDR-SNU719-DMSO-april2017-v0.RData")
