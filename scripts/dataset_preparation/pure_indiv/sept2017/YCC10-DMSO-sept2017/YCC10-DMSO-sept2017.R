...
## Set directory
setwd("/Users/serena/scrnaseq/results/pure_indiv/sept2017/YCC10-DMSO-sept2017")
...
setwd("/Users/serena/scrnaseq/results/pure_indiv/sept2017/YCC10-DMSO-sept2017")
save(YCC10.DMSO.sept2017.seuratobject, file="filtered-YCC10-DMSO-sept2017-v0.RData")
...
YCC10.DMSO.sept2017.phase <- RunPCA(YCC10.DMSO.sept2017.seuratobject)
# Plot the PCA colored by cell cycle phase
# Should observe variation by cell cycle
png('Cell Cycle PCA.png')
DimPlot(YCC10.DMSO.sept2017.phase,
       reduction = "pca",
       group.by = "Phase")
dev.off()
# Run SCTransform: Normalizes data, Scales Data, Finds variable features
...
# Perform PCA
YCC10.DMSO.sept2017.phase.regressed <- RunPCA(YCC10.DMSO.sept2017.seuratobject)

# Now, a PCA on the variable genes no longer returns components associated with cell cycle
png('Cell Cycle Regressed PCA.png')
DimPlot(YCC10.DMSO.sept2017.phase.regressed,
        reduction = "pca",
        group.by= "Phase")
dev.off()
...
save(YCC10.DMSO.sept2017.seuratobject, file="SCT-YCC10-DMSO-sept2017-v0.RData")
...
setwd("/Users/serena/scrnaseq/results/pure_indiv/sept2017/YCC10-DMSO-sept2017")
save(YCC10.DMSO.sept2017.seuratobject, file="LDR-YCC10-DMSO-sept2017-v0.RData")
