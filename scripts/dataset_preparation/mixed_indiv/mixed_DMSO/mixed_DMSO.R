...
## Set directory
setwd("/Users/serena/scrnaseq/results/mixed_indiv/mixed_DMSO")
...
setwd("/Users/serena/scrnaseq/results/mixed_indiv/mixed_DMSO/Quality Metric Plots")
...
mixed.DMSO.phase <- RunPCA(mixed.DMSO.seuratobject)
# Plot the PCA colored by cell cycle phase
# Should observe variation by cell cycle
png('Cell Cycle PCA.png')
DimPlot(mixed.DMSO.phase,
       reduction = "pca",
       group.by = "Phase")
dev.off()
# Run SCTransform: Normalizes data, Scales Data, Finds variable features
...
# Perform PCA
mixed.DMSO.phase.regressed <- RunPCA(mixed.DMSO.seuratobject)

# Now, a PCA on the variable genes no longer returns components associated with cell cycle
png('Cell Cycle Regressed PCA.png')
DimPlot(mixed.DMSO.phase.regressed,
        reduction = "pca",
        group.by= "Phase")
dev.off()
...
setwd("/Users/serena/scrnaseq/results/mixed_indiv/mixed_DMSO/Linear Dimensional Reduction")
...
DimPlot(mixed.DMSO.seuratobject, reduction = "pca")
...
setwd("/Users/serena/scrnaseq/results/mixed_indiv/mixed_DMSO")
save(mixed.DMSO.seuratobject, file="LDR-mixed_DMSO-v0.RData")
